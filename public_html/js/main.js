...
var FigureSet = function () {
    ...
    this.addFigure = function (node, figure) {
        ...
        var hola = document.getElementById(_reqdId);
        hola.appendChild(_figureElement);
...
var Game = function (_figureSet) {
    ...
    this.setKey = function (lvl) {
        ...
        this.key = lvl.figures[lastFigure];
...
function main(_folder, _ext) {
    ...
    var figureGame = new FigureGame(_folder, _ext);
    ...
    figureGame.dndHandler.setFigures(playerItems);
    figureGame.dndHandler.setSystemBoxes(systemItems);
